(function (factory) {
  ...
  L.Control.Geocoder = L.Control.extend({
    ...
    onAdd: function (map) {
      ...
      const icon = L.DomUtil.create('div', 'leaflet-control-geocoder-icon', container);
			    const form = this._form = L.DomUtil.create('form', className + '-form', container);
			    let input;
    ...
    _createAlt: function (result, index) {
      const li = document.createElement('li');
			    ...
			    const icon = this.options.showResultIcons && result.icon ? L.DomUtil.create('img', '', a) : null;
			    const text = result.html ? undefined : document.createTextNode(result.name);
    ...
    _keydown: function (e) {
      const _this = this;
      const select = function select (dir) {
        if (_this._selection) {
  ...
  L.Control.Geocoder.jsonp = function (url, params, callback, context, jsonpParam) {
    const callbackId = '_l_geocoder_' + (L.Control.Geocoder.callbackId++);
